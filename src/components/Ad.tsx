    ...
    <div className="p-4 bg-white shadow-md rounded-lg text-sm">
      ...
      >
        ...
        <div className="flex items-center gap-4">
          ...
          />
          <span className="text-blue-500 font-medium">CBD oil</span>
        </div>
        <p className={size === "sm" ? "text-xs" : "text-sm"}>
          {size === "sm"
            ? "Get 10% off on your first order"
            : size === "md"
            ? "Get 10% off on your first order with this coupon code"
            : "Get 10% off on your first order with this coupon code. Hurry up! Limited time offer. Order now!"}
        </p>
